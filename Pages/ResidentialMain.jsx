        ...
        <Container fluid className="vh-100 d-flex justify-content-center align-items-center">
            <Row>
                ...
                <div className="whyResidential">
                    <h3> Why You Need Residential Cleaning Services </h3>
                ...
                <div className="howResidential">
                    <h3> How Residential Cleaning Helps You </h3>
                    <ul>
                ...
                <div className="includedResidential">
                    <h3>What Does Residential Cleaning with Rux Cleaning Include?
</h3>
                ...
                <div className="surroundingAreas">
                    <h3>Serving Bolingbrook and Surrounding Areas</h3>
